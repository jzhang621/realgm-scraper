"""
Scrape all NCAA D1 conference standings to get team games played for 2023-24
"""
...
for conf_id, conf_slug, conf_name in CONFERENCES:
    url = f"https://basketball.realgm.com/ncaa/conferences/{conf_slug}/{conf_id}/standings/2024"
    print(f"Fetching {conf_name} (2023-24)...")
...
# Save to CSV
output_file = 'data/processed/team_games_2024.csv'
