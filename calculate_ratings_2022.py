"""
Calculate player ratings for 2021-22 NCAA D1 season using RealGM data.
...
team_games = {}
with open('data/processed/team_games_2022.csv', 'r') as f:
...
with open('data/processed/player_stats_misc.csv', 'r') as f:
    for row in csv.DictReader(f):
        if row['season'] == '2021-22' and row['team'] in team_games:
...
output_file = 'data/processed/player_ratings_2022.csv'
