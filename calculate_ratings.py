"""
Calculate player ratings for 2025-26 NCAA D1 season using RealGM data.
...
with open('data/processed/player_stats_misc.csv', 'r') as f:
    reader = csv.DictReader(f)
    for row in reader:
        if row['season'] == '2025-26' and row['team'] in team_games:
...
# Write to CSV
output_file = 'data/processed/player_ratings_2026.csv'
