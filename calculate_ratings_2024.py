"""
Calculate player ratings for 2023-24 NCAA D1 season using RealGM data.
...
# Load team games
team_games = {}
with open('data/processed/team_games_2024.csv', 'r') as f:
...
with open('data/processed/player_stats_misc.csv', 'r') as f:
    reader = csv.DictReader(f)
    for row in reader:
        if row['season'] == '2023-24' and row['team'] in team_games:
...
# Write to CSV
output_file = 'data/processed/player_ratings_2024.csv'
