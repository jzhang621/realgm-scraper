"""
scrape_missing_2023.py

Seeds the 1,224 players who appear in the 2022-23 season roster but were never
scraped, then fetches their profiles.

Run:
  python3 scrape_missing_2023.py --use-browser
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(os.path.join(config.ROOT_DIR, "scrape_missing_2023.log"), encoding="utf-8"),
    ],
)
...
def find_missing_players():
    """Return player dicts for 2022-23 roster players not yet in the checkpoint."""
    # Players in the 2022-23 roster
    roster = {}  # player_id -> url_slug
    ...
    # Players already in the checkpoint
    import sqlite3
...
def main():
    ...
    parser.add_argument("--use-browser", action="store_true", required=True,
                        help="Use Playwright browser fetcher")
